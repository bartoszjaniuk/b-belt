...
[![npm version](https://img.shields.io/npm/v/@i3artosh/b-belt.svg)](https://www.npmjs.com/package/@i3artosh/b-belt)
...
- **Status:** MVP. Package is set up for publication on [npm](https://www.npmjs.com/package/@i3artosh/b-belt), with CI/CD (GitHub Actions) for tests, build, and release on tag push using semantic-release.
